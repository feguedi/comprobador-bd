...
SET DEFINE OFF;
Insert into SYSTEM.CARRO (ID_CAR,NOMBRE,"AÑO",TIPO,VERSION,COLOR,MODELO,ID_MAR) values (123,'SEAT Sport',1975,'turistico','Sport','verde','1430 Sport',489);
Insert into SYSTEM.CARRO (ID_CAR,NOMBRE,"AÑO",TIPO,VERSION,COLOR,MODELO,ID_MAR) values (753,'Chevrolet Isuzu',1989,'turistico','Isuzu','gris','Passport',487);
Insert into SYSTEM.CARRO (ID_CAR,NOMBRE,"AÑO",TIPO,VERSION,COLOR,MODELO,ID_MAR) values (962,'Fiat Coupé',1992,'deportivo','Coupé','negro','20V Turbo',102);
...
Insert into SYSTEM.CARRO (ID_CAR,NOMBRE,"AÑO",TIPO,VERSION,COLOR,MODELO,ID_MAR) values (234,'Nissan 280 ZX',1978,'deportivo','datsun','rojo','280 ZX',258);
